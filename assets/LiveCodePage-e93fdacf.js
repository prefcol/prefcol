import{aB as D,aC as $}from"./index-255f9f49.js";import{j as e}from"./vendor-chakra-9f839143.js";import{r as l,W as B}from"./vendor-react-d4f1e0e3.js";import{v as V,w as W,x as z,y as G,z as q}from"./index-62d2f787.js";import{m as b}from"./vendor-motion-19be6d4d.js";import"./vendor-antd-b5bec7a4.js";const Q=B.lazy(()=>$(()=>import("./index-730fd0e7.js"),["assets/index-730fd0e7.js","assets/vendor-react-d4f1e0e3.js"])),Y=[{id:"c",label:"C"},{id:"cpp",label:"C++"},{id:"java",label:"Java"},{id:"python",label:"Python"},{id:"javascript",label:"JavaScript"},{id:"html",label:"HTML / CSS / JS"},{id:"sql",label:"SQL"},{id:"php",label:"PHP"},{id:"csharp",label:"C#"},{id:"go",label:"Go"},{id:"rust",label:"Rust"}],E={c:`#include <stdio.h>
...
`},T="prefcol_livecode_state_v1",K=()=>{if(typeof window>"u")return null;try{const t=localStorage.getItem(T);return t?JSON.parse(t):null}catch{return null}},X=t=>{if(!(typeof window>"u"))try{localStorage.setItem(T,JSON.stringify(t))}catch{}};function oe(){const t=K(),[r,k]=l.useState((t==null?void 0:t.language)||"javascript"),[i,S]=l.useState((t==null?void 0:t.code)||E[(t==null?void 0:t.language)||"javascript"]),[u,_]=l.useState((t==null?void 0:t.input)||""),[f,d]=l.useState((t==null?void 0:t.output)||""),[x,n]=l.useState((t==null?void 0:t.error)||""),[g,c]=l.useState((t==null?void 0:t.executionTime)||""),[v,I]=l.useState((t==null?void 0:t.theme)||"vs-dark"),[y,C]=l.useState(!1),[j,M]=l.useState(!1),R=typeof import.meta<"u"&&{BASE_URL:"/",MODE:"production",DEV:!1,PROD:!0,SSR:!1}.VITE_COMPILE_API_URL||"/api/compile";l.useEffect(()=>{X({language:r,code:i,input:u,output:f,error:x,executionTime:g,theme:v})},[r,i,u,f,x,g,v]);const H=s=>{k(s),S(a=>a&&a.trim()&&s===r?a:E[s]||""),d(""),n(""),c("")},O=async()=>{try{await navigator.clipboard.writeText(i||"")}catch{}},F=()=>{const s=new Blob([i||""],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(s),a.download=`code-${r}.txt`,a.click(),URL.revokeObjectURL(a.href)},U=()=>{var o;const s=document.getElementById("live-html-preview");if(!s)return;const a=s.contentDocument||((o=s.contentWindow)==null?void 0:o.document);a&&(a.open(),a.write(i||""),a.close(),d("Rendered HTML preview."),n(""),c(""))},A=async()=>{if(!i||!i.trim()){n("Nothing to run. Please write some code first."),d(""),c("");return}C(!0),n(""),d(""),c("");const s=performance.now();try{if(r==="html"){U();const m=performance.now()-s;c(`${(m/1e3).toFixed(2)}s`);return}const a=await fetch(R,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({language:r,code:i,input:u})}),o=await a.json().catch(()=>({})),p=performance.now()-s;c(o.executionTime||`${(p/1e3).toFixed(2)}s`);const h=!["javascript","html"].includes(r),w=!a.ok&&(a.status===404||a.status===405||a.status===0),N=(o.error==="Compilation failed"||!o.error)&&!o.output;if(w&&h){const m=a.status===405?`
